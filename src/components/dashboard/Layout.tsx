        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-800">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-bubbles-blue rounded-full flex items-center justify-center text-white">
            ...
            {menuItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(item.path)
                    ? "bg-bubbles-blue/10 text-bubbles-blue"
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
              <div className="w-9 h-9 rounded-full bg-bubbles-teal/20 flex items-center justify-center">
                <span className="text-sm font-semibold text-bubbles-teal">SA</span>
              </div>
              <div className="flex-grow">
                <div className="text-sm font-medium">Sarah Anderson</div>
                <div className="text-xs text-gray-500">Parent Account</div>
              </div>
              <Link to="/" className="text-gray-500 hover:text-bubbles-blue">
                <LogOut size={18} />
              </Link>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="lg:pl-64">
        {/* Top bar */}
        <header className="sticky top-0 z-30 bg-white dark:bg-bubbles-deep border-b border-gray-200 dark:border-gray-800">
          <div className="px-4 h-16 flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold lg:hidden">Bubbles Dashboard</h1>
            ...
            <div className="flex items-center gap-4">
              <button className="p-2 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 relative">
                <Bell size={20} />
                <span className="absolute top-1 right-1 w-2 h-2 bg-bubbles-blue rounded-full"></span>
              </button>
            </div>
          </div>
        </header>
